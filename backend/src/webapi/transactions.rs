...
#[get("/transactions/<id>")]
pub(crate) async fn get_transaction_by_id(app_state: &State<api::AppState>, id: i64) -> Option<Json<Transaction>> {
    let storage_system = app_state.get_storage_system();
...
pub async fn post_transaction(app_state: &State<api::AppState>, input: Json<Transaction>) -> Result<Json<Transaction>, BadRequest<Json<MessageResponse>>> {
    let storage_system = app_state.get_storage_system();
...
pub async fn delete_transaction(app_state: &State<api::AppState>, id: i64) -> Result<Json<Transaction>, BadRequest<Json<MessageResponse>>> {
    let storage_system = app_state.get_storage_system();
