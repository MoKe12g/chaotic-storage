...
pub(crate) async fn get_allocation_by_id(app_state: &State<api::AppState>, allocation_id: i64) -> Result<Json<CountOfItemsInAllocation>, BadRequest<Json<MessageResponse>>> {
